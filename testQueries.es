...
Hospital, Enquiry, Defies, Prime, Minister : Word ;

: \exists x.(> if (= x Hospital) then 1
         else if (= x Enquiry) then 1
         else if (= x Defies) then 1
         else if (= x Prime) then 1
         else if (= x Minister) then 1
         else 0 0) ;
